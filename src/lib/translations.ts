...
export const translations = {
  de: {
    ...
    manualFleetTitle: 'Eigene Container-Flotte',
    manualFleetDesc: 'Kombiniere mehrere Container manuell (Manuelle Vorgabe).',
    fleetAddBtn: '+ Container hinzufügen',
    fleetContainerPlaceholder: '-- Bitte wählen --',
    ...
    btnPrintPacklist: '🖨️ Packliste drucken',
  ...
  en: {
    ...
    manualFleetTitle: 'Custom Container Fleet',
    manualFleetDesc: 'Combine multiple specific containers manually.',
    fleetAddBtn: '+ Add container',
    fleetContainerPlaceholder: '-- Please select --',
    ...
    btnImportExcel: '📄 Excel/CSV Import',
    btnPrintPacklist: '🖨️ Print Packlist',
